...
export const meta = {
  ...
  description: "For an example, if we set the GOPATH environment variable to _/tmp/go1:/tmp/go2:/tmp/go3_ all three of them will act as GOPATHs.",
  intro: (
    <section>
      <p>For an example, if we set the GOPATH environment variable to _/tmp/go1:/tmp/go2:/tmp/go3_ all three of them will act as GOPATHs.</p>
    </section>
  ),
  date: "2016-01-18",
  tags: ["go"],
