...
import img1 from './images/1-D2GJjRg5Ss_4KcskGrmN-Q.png';
import img2 from './images/1-cwXIknjf3--tjO2QSSo3MQ.png';

export const meta = {
  title: "Debugging duplicate click events",
  description: "While trying to debug this issue, we found out a couple of interesting things about how Angular manages event handlers.",
  intro: (
    <section>
      <p>While trying to debug this issue, we found out a couple of interesting things about how Angular manages event handlers.</p>
    </section>
  ),
  date: "2017-06-27",
  tags: ["js","angular"],
...
<img src={img1} alt="Screenshot taken during the second click event emit with the stack trace" />
...
<img src={img2} alt="Screenshot of the list of event listeners on the app-test-button element" />
