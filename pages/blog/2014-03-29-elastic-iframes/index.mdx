...
export const meta = {
  ...
  intro: (
    <section>
      <p>Sometimes it become necessary to use iframes when building some web  applications. Often we have them hidden but sometimes iframes can be  useful visible too.</p>
    </section>
  ),
  date: "2014-03-29",
  tags: ["js"],
