...
export const meta = {
  ...
  description: "This are undocumented internal details of RxJS and it can break anytime. It probably would have changed by the time you're reading this blog post. But still, there can be something similar.",
  intro: (
    <section>
      <p>This are undocumented internal details of RxJS and it can break anytime. It probably would have changed by the time you're reading this blog post. But still, there can be something similar.</p>
    </section>
  ),
  date: "2018-09-05",
  tags: ["js","rxjs"],
