...
export const meta = {
  ...
  description: "If you’re maintaining a javascript project on Github there’s a good chance you’re using a transpiler. Most developers don’t publish transpiled code to Github because it makes your pull requests look messed up and it’s difficult to keep source and transpiled code in sync.",
  intro: (
    <section>
      <p>If you’re maintaining a javascript project on Github there’s a good chance you’re using a transpiler. Most developers don’t publish transpiled code to Github because it makes your pull requests look messed up and it’s difficult to keep source and transpiled code in sync.</p>
    </section>
  ),
  date: "2016-07-13",
  tags: ["github","js"],
